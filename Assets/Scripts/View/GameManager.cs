...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        player.CollidedWithEnemy += OnCollidedWithEnemy;
        player.CollidedWithBomb += OnCollidedWithBomb;
    ...
    private void OnCollidedWithEnemy(Vector3 collisionPoint)
    {
    ...
    private void OnCollidedWithBomb(Vector3 collisionPoint)
    {
        enemyManager.SwitchEnemySpawn(false);
        enemyManager.StopMoveEnemies();
        dragPanel.gameObject.SetActive(false);
        ...
        camera.SwitchLookAtPlayer(false);
    }
    ...
    private void OnPressReplayButton()
    {
        ...
        camera.SwitchLookAtPlayer(true);
    }
}